...
public class TestEx1 extends ChromeTest {
    ...
    public void checkHeader() {
        ...
        List<WebElement> headers = driver.findElements(By.cssSelector("ul[class='uui-navigation"
                + " nav navbar-nav m-l8']>li"));
    ...
    public void checkIconsText() {
        List<String> expText = List.of("To include good practices\nand ideas from successful\nEPAM project",
    ...
    public void checkLeftSection() {
        List<String> itemLeftMenu = List.of("Home", "Contact form", "Service", "Metals & Colors", "Elements packs");
